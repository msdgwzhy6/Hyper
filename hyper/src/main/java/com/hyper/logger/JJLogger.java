...
public class JJLogger {
     ...
     * @param errorCode 错误码
     */
    public static void logErrorCode(String msg, String errorCode) {
        if (isDebug) {
    ...
    private static void printLocation(char type, String tag, String... msg) {
        ...
        sb.append(HORIZONTAL_DOUBLE_LINE).append("   invoked at：").append(location)/*
                .append("\n").append(HORIZONTAL_DOUBLE_LINE).append("   类名：").append(className)
                .append("\n").append(HORIZONTAL_DOUBLE_LINE).append("   方法名：").append(methodName)
                .append("\n").append(HORIZONTAL_DOUBLE_LINE).append("   第 ").append(lineNumber).append(" 行")*/;
