package com.hyper.http.core;

import android.os.AsyncTask;
import android.os.Handler;
import android.text.TextUtils;

import com.hyper.InitSDK;
...
import static com.hyper.http.core.ConfigHttp.HTTP_TYPE_GET;
import static com.hyper.http.core.ConfigHttp.HTTP_TYPE_POST;
import static com.hyper.http.core.ConfigHttp.httpType;
import static com.hyper.http.core.ConfigHttp.mHttpTimeout;
        ...
        try {
            ...
            if (httpUrlCon.getResponseCode() == HttpURLConnection.HTTP_OK) {
                ...
                if (!interceptFlag){
                    ...
                    interceptFlag = false;
                    JJLogger.logInfo("HttpTask","取消连接");
                }
...
//            e.printStackTrace();
            //如果需要处理超时，可以在这里写
            JJLogger.logErrorCode("disconnect","断开连接"+e.getMessage());
...
//                    mHttpCallback.onFailure(e, 0);
            ...
            if (httpUrlCon != null) {
                ...
                JJLogger.logErrorCode("disconnect","断开连接");
               interceptFlag = false;
            }
        }
        return null;
    ...
    @Override
     protected void onPostExecute(RETURN  s) {
        ...
        if (s == null) {
            JJLogger.logInfo("onPostExecute","HttpTask:onPostExecute :没有得到数据");
        }
